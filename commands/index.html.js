      ...
      const app = Vue.createApp({
        ...
        methods: {
          ...
          buildingCost(building){
            let level = this.buildingLevel(building);
            if(level === 0){ return building.l1.cost }

            return building[`l${level}`].cost;
          },
          buildingIncome(building){
            let level = this.buildingLevel(building);
            if(level === 0){ return building.l1.income }

            return building[`l${level}`].income;
          },
