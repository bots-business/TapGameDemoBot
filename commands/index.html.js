        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content bg-dark text-light">
            ...
            <div class="modal-body text-center">
              ...
              <button @click="topModal.onClick"
                      :class="['btn', 'btn-lg', 'w-100', topModal.button_enabled ? 'btn-primary' : 'btn-secondary']"
                      :disabled="!topModal.button_enabled">
        ...
        methods: {
          ...
          getBuildingParam(building, param, for_next_level = false) {
            ...
            if(for_next_level&&(effectiveLevel > 1)){
              // we need cost for next level except 0 level
              effectiveLevel += 1
            }
